(() => {
  ...
  var require_element = __commonJS({
    "lib/elements/element.js"(exports, module) {
      ...
      module.exports = Element = function(format2) {
        if (format2 === void 0)
          format2 = new Format2();
        this.format = format2;
      };
  ...
  var require_text = __commonJS({
    "lib/elements/text.js"(exports, module) {
      ...
      module.exports = TextElement = function(text, format2) {
        Element2.apply(this, [format2]);
        this.text = text;
      };
      TextElement.subclass(Element2);
  ...
  var require_link = __commonJS({
    "lib/elements/link.js"(exports, module) {
      var Element2 = require_element();
      module.exports = LinkElement = function(text, url, format2) {
        Element2.apply(this, [format2]);
        this.text = text;
        this.url = url;
      };
      LinkElement.subclass(Element2);
  ...
  var require_group = __commonJS({
    "lib/elements/group.js"(exports, module) {
      ...
      module.exports = GroupElement = function(name, format2) {
        Element2.apply(this, [format2]);
        this.elements = [];
        this.name = name;
      };
      GroupElement.subclass(Element2);
      GroupElement.prototype.addElement = function(element2) {
  ...
  var require_rtf = __commonJS({
    "lib/rtf.js"(exports, module) {
      ...
      var Format2 = require_format();
      var Utils = require_rtf_utils();
      var Language2 = require_language();
      var Orientation2 = require_orientation();
      var TextElement2 = require_text();
      var LinkElement2 = require_link();
      var GroupElement2 = require_group();
      var async = require_async();
      module.exports = RTF = function() {
        ...
        this.marginTop = 1440;
        this.language = Language2.ENG_US;
        this.columns = 0;
        this.columnLines = false;
        this.orientation = Orientation2.PORTRAIT;
        this.elements = [];
        this.colorTable = [];
        this.fontTable = [];
      };
      RTF.prototype.writeText = function(text, format2, groupName) {
        element = new TextElement2(text, format2);
      ...
      RTF.prototype.writeLink = function(text, url, format2, groupName) {
        element = new LinkElement2(text, url, format2);
        if (groupName !== void 0 && this._groupIndex(groupName) >= 0) {
          this.elements[this._groupIndex(groupName)].push(element);
        } else {
          this.elements.push(element);
      ...
      RTF.prototype.addTextGroup = function(name, format2) {
        if (this._groupIndex(name) < 0) {
          formatGroup = new GroupElement2(name, format2);
      ...
      RTF.prototype._groupIndex = function(name) {
        this.elements.forEach(function(el, i) {
          if (el instanceof GroupElement2 && el.name === name) {
            return i;
          }
        });
        return -1;
      ...
      RTF.prototype.createDocument = function(callback) {
        ...
        if (this.orientation == Orientation2.LANDSCAPE)
          output += "\\landscape";
